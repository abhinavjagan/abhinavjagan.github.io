...
function CvSceneCanvas() {
  ...
  useEffect(() => {
    ...
    loadModel(
      publicUrl("assets/media/miles_from_spider-man_across_the_spider_verse.glb"),
      (model, animations) => {
      ...
      // Model missing from /public is OK — CV content still works.
    });
