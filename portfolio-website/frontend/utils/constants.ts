...
export const PROJECTS = [
  {
    ...
    description:
      'Built a public, local-first AI application that turned a consented persona interview into grounded drafts through retrieval, optional research, critique, and human approval.',
    details: [
    ...
    category: 'Open Source · AI Systems',
    status: 'Public build',
  ...
  },
  {
    ...
    links: [],
    category: 'Professional · AI Infrastructure',
  ...
  },
  {
    ...
    links: [],
    category: 'Professional · AI Systems',
  ...
  },
  {
    ...
    links: [],
    category: 'Professional · Distributed Systems',
    status: 'Completed professional work',
  ...
  },
  {
    ...
    links: [],
    category: 'Professional · Network Systems',
    status: 'Delivered professional work',
